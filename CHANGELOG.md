...
- P2: 剩余角色（`skills/analyst.md` + `agents/developer|tester|reviewer|dba.md` + `commands/bugfix|lint.md`）
- P3: `docs/claude-md-template.md`、`docs/onboarding.md`、`docs/migration-from-local.md`、`examples/<profile>-snippet.md`
- P4: 真实项目自消耗闭环验证
- P5: 外部用户试装验证
